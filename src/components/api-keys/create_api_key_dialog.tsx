...
import { CreateApiKeyFormData } from "@/types/api_keys";
import { createApiKey } from "@/actions/api-keys/api_key_actions";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
interface CreateApiKeyDialogProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: (key: { key: string; name: string; keyId: string }) => void;
