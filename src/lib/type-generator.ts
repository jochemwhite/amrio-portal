...
export function generateTypeScript(
  ...
  lines.push(" * ");
  lines.push(" * const response = await supabase.rpc('get_page_content', {");
  lines.push(" *   page_id_param: 'your-page-id',");
  lines.push(" *   website_id_param: 'your-website-id'");
  lines.push(" * });");
  lines.push(" * ");
  lines.push(" * const pageData: PageContent = response.data[0];");
  lines.push(" * ```");
  lines.push(" */");
  lines.push("");
